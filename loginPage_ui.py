...
class Ui_GameOptionsPage(object):
    def setupUi(self, GameOptionsPage):
        ...
        #this code will set the size and name for the window
        GameOptionsPage.resize(640, 480)
        self.centralwidget = QtGui.QWidget(GameOptionsPage)
        self.centralwidget.setObjectName("centralwidget")
        #this will be the code for the title of the page 
        self.Pg7titleLbl = QtGui.QLabel(self.centralwidget)
        self.Pg7titleLbl.setGeometry(QtCore.QRect(240, 40, 140, 50))
        font = QtGui.QFont()
        font.setPointSize(26)
        font.setBold(True)
        font.setWeight(75)
        self.Pg7titleLbl.setFont(font)
        self.Pg7titleLbl.setObjectName("Pg7titleLbl")
